...
export function UpgradeDialog() {
  ...
  const checkoutPlan: CheckoutPlan = cycle;
          ...
          <div className="grid gap-6 p-6 pt-5 md:grid-cols-2">
            ...
            <div className="flex flex-col rounded-[16px] border border-border bg-card2 p-4">
              ...
              <div className="mt-3 space-y-2.5">
                <PlanRow active={cycle === "monthly"} onClick={() => setCycle("monthly")} label={t("pro.monthly")} price="R$ 9,90" per={t("pro.perMonth")} />
                <PlanRow active={cycle === "annual"} onClick={() => setCycle("annual")} label={t("pro.annual")} price="R$ 100" per={t("pro.perYear")} hint={t("pro.annualHint")} />
              </div>

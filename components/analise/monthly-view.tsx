...
/**
 * Visão "Meses" do Histórico — insights dos últimos 6 meses: tendência de
 * receita/despesa/sobra, top categorias do mês e maiores variações.
 */
export async function MonthlyView({ month }: { month?: string }) {

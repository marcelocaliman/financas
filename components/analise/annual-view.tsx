...
/**
 * Visão "Ano" do Histórico — fechamento fiscal do ano: fluxo mês a mês, top
 * categorias, bens declaráveis em 31/dez, movimentos de investimento, proventos
 * por regime e export. Referência pra preencher o IRPF.
 */
export async function AnnualView({ year }: { year: number }) {
  ...
  const headerActions = (
    <div className="flex items-center gap-2.5">
      <ViewSwitcher view="ano" />
      <YearSwitcher current={report.year} />
    </div>
  );

      ...
      {undone ? (
        ...
        <Tooltip content="Desfazer esta ação">
          <button
            ...
            disabled={pending}
            aria-label="Desfazer"
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-[7px] text-[12px] text-muted-foreground hover:text-foreground hover:bg-bone-100 dark:hover:bg-ink-800 transition-colors disabled:opacity-40"
          >
            <Undo2 className="w-3.5 h-3.5" strokeWidth={1.7} />
            {pending ? "…" : "Desfazer"}
          </button>
        </Tooltip>
      )}

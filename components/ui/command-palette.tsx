...
export function CommandPalette() {
  ...
  const commands = useMemo<Command[]>(
    () => [
      ...
      { id: "ana", label: "Histórico (meses)", icon: <LineChart className="w-3.5 h-3.5" />, action: () => router.push("/analise") },
      { id: "rel", label: "Histórico · relatório anual", icon: <FileText className="w-3.5 h-3.5" />, action: () => router.push("/analise?view=ano") },
